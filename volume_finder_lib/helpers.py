...
from . volume_finderconfig import get_data_file
...
def get_builder(builder_file_name):
    ...
    builder = Builder()
    builder.set_translation_domain('volume-finder')
...
def set_up_logging(opts):
    ...
    lib_logger = logging.getLogger('volume_finder_lib')
