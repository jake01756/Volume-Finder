...
# This class is meant to be subclassed by VolumeFinderWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseVolumeFinderWindow object.
        """
        builder = get_builder('VolumeFinderWindow')
        new_object = builder.get_object("volume_finder_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a VolumeFinderWindow object with it in order to finish
        initializing the start of the new VolumeFinderWindow instance.
        """
        ...
        self.WelcomeDialog = None # class

        self.settings = Gio.Settings("net.launchpad.volume-finder")
        ...
        try:
            from volume_finder import indicator
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for volume-finder."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the VolumeFinderWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the VolumeFinderWindow is closed."""
